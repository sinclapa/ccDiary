...
.env-badge--local   { --env-c: 6, 182, 212; }
.env-badge--dev     { --env-c: 245, 158, 11; }
.env-badge--staging { --env-c: 251, 146, 60; }

.env-badge--local,
.env-badge--dev,
.env-badge--staging {
  color: rgb(var(--env-c));
  border-color: rgba(var(--env-c), 0.35);
  background: rgba(var(--env-c), 0.12);
}
